 ...
 * Generated at: 2017-07-14 03:39:59 UTC
...
public final class pressRecord_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<a href=\"#\">试验室数据采集</a>\r\n");
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t\t<li class=\"active\">压力机实时数据查看</li>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-xs-2 column\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-xs-4 column\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"form-field-select-1\">项目名称</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-xs-8 column\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\"  id=\"form-field-select-1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">工程部</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"AL\">实施部</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">序号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">试验室名称</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">设备名称</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">试验类型</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">设计强度 </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">试件编号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">施工部位</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">龄期</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">试件尺寸</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">设计强度 </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">荷载(kN)</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">强度单值 </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">查看曲线 </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">强度代表值 </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">是否合格 </th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Clicks</th>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-time bigger-110\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tUpdate\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      ...
      out.write("<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/app/js/jquery.dataTables.min.js\"></script>\r\n");
      out.write("<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/app/js/jquery.dataTables.bootstrap.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\r\n");
