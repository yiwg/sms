            ...
            <ul class="nav nav-list">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/project/gotoProjectCfg.do" target="iframe">
                                <i class="icon-double-angle-right"></i>
                                工程配置
                            </a>
                        </li>
...
<div>
    <iframe src="${pageContext.request.contextPath}/index/map.do" frameborder="0" name="iframe"  width="85%" onload="setIframeHeight(this)"
            background-color="#red"></iframe>
    <script>
